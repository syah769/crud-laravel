...
<head>
    ...
    <!-- tak perlu berulang kali tempek code css. Just guna recall saja kalau nak guna. Boleh tgk datapegawai.blade.php, ada code dia  -->
    @stack('css')
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <!-- tak perlu berulang kali tempek code js. Just guna recall saja kalau nak guna. Boleh tgk datapegawai.blade.php, ada code dia -->
    @stack('scripts')
